...
export async function AgentWalletSummary({ agents }: AgentWalletSummaryProps) {
  ...
  return (
    <section className="glass-card bg-white/5 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-white">Agent Wallet Preview</h2>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-3">
        <div className="rounded-lg border border-white/10 bg-white/5 p-4">
          <p className="text-xs uppercase tracking-wider text-fly-muted">Balance</p>
          <p className="text-2xl font-semibold text-emerald-300">
            {wallet.currency} {wallet.balance}
          </p>
        </div>
        <div className="rounded-lg border border-white/10 bg-white/5 p-4">
          <p className="text-xs uppercase tracking-wider text-fly-muted">Trust Score</p>
          <p className="text-2xl font-semibold text-emerald-300">{trust.trustScore}</p>
        ...
        <div className="rounded-lg border border-white/10 bg-white/5 p-4">
          <p className="text-xs uppercase tracking-wider text-fly-muted">Reserved</p>
          <p className="text-2xl font-semibold text-amber-300">{wallet.reserved}</p>
        </div>
      </div>
    </section>
  );
