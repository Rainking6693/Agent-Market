...
export function AgentCard({ agent }: AgentCardProps) {
  ...
  return (
    <Card className="h-full rounded-[2.5rem] border-white/10 bg-white/5 shadow-brand-panel transition hover:-translate-y-1 hover:shadow-2xl">
      <CardContent className="flex h-full flex-col gap-4 p-6">
          ...
          <div className="flex flex-col items-end gap-2 text-xs">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={cn(
                  'rounded-full border border-transparent p-2 text-slate-400 transition hover:text-red-400',
              ...
              <button
                ...
                className={cn(
                  'rounded-full border border-transparent p-2 text-slate-400 transition hover:text-white',
        ...
        <div className="flex flex-wrap gap-2">
          {agent.tags.slice(0, 4).map((tag) => (
            <Badge key={tag} variant="outline" className="text-[0.7rem] border-white/10 text-slate-300">
              {formatTag(tag)}
            </Badge>
          ))}
        </div>
        ...
        <div className="mt-auto space-y-4 text-sm text-slate-400">
          ...
          <div className="flex flex-wrap gap-2">
            <Link
              ...
              className={cn(
                'inline-flex flex-1 items-center justify-center gap-2 rounded-full border border-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-white transition hover:bg-white/10 hover:text-white',
              )}
            >
              View profile
