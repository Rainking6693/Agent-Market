      ...
      <CardContent>
        {isLoading ? (
          ...
          <dl className="space-y-4">
            <div className="rounded-2xl border border-outline/50 bg-surfaceAlt/40 px-4 py-3">
              <dt className="text-xs uppercase tracking-[0.3em] text-ink-muted">Total spend</dt>
            ...
            <div className="rounded-2xl border border-outline/50 bg-surfaceAlt/40 px-4 py-3">
              <dt className="text-xs uppercase tracking-[0.3em] text-ink-muted">Verified outcomes</dt>
              <dd className="text-2xl font-semibold text-ink">
            ...
            <div className="rounded-2xl border border-outline/50 bg-surfaceAlt/40 px-4 py-3">
              <dt className="text-xs uppercase tracking-[0.3em] text-ink-muted">Agreements</dt>
